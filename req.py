"""program to demonstrate requests"""
import requests
r_for_content=requests.get('https://httpbin.org/basic-auth/something/prx',
auth=('something','prx'),timeout=10)
r_for_image=requests.get('https://picsum.photos/200/300',timeout=10)
...
r_post=requests.post("http://httpbin.org/post",data=payload,timeout=10)
#print(r_post.text)
#or
r_dict=r_post.json()
print(r_dict['form'])
